...
class TestSuite:
    ...
    def run_test(self):
        ...
        if str(self.network_attack) == "SYN Flood":
            if str(self.adversarial_attack) == "Evasion: Rate":
                result = self.rate_evasion(1000, 45000)
            elif str(self.adversarial_attack) == "Evasion: Payload":
                result = self.payload_evasion(1000, 90)
            elif str(self.adversarial_attack) == "Evasion: Pairflow":
                result = self.pairflow_evasion(1000, 1500)
            elif str(self.adversarial_attack) == "Evasion: Rate+Payload":
                result = self.rate_payload_evasion(1000, 45000, 90)
            elif str(self.adversarial_attack) == "Evasion: Rate+Pairflow":
                result = self.rate_pairflow_evasion(1000, 45000, 45000)
            elif str(self.adversarial_attack) == "Evasion: Payload+Pairflow":
                result = self.payload_pairflow_evasion(1000, 90, 1500)
            elif str(self.adversarial_attack) == "Evasion: Stealth":
                result = self.stealth_evasion(1000, 90, 1500, 1500)
            else:
